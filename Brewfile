...
brew "macchina"           # System information fetcher, with an emphasis on performance and minimalism
...
brew "blueutil"             # Get/set bluetooth power and discoverable state
brew "folly"                # Collection of reusable C++ library artifacts developed at Facebook
...
brew "ntfs-2g"              # Read-write NTFS driver for FUSE
...
mas "New File Menu Free", id: 1066302071
